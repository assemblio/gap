...
<div class="main">
		<div class="det-para">
			<h4 class="top para"> Regjistrimi i veturave ne baze te firmes. </h4>
		<div class="det-para">
			 <iframe class="highcharts-iframe" src="//cloud.highcharts.com/embed/usevyq" style="border: 0; width: 100%; height: 500px"></iframe>
			 </div>
		</div>
		<div class="clear"></div>
	</div>
